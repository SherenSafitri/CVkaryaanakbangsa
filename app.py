...
def main():
    ...
    st.title("Tentang CV.KaryaAnakBangsa")
    st.markdown("<p style='font-size: 18px; text-align: justify;'>CV. Karya Anak Bangsa merupakan badan usaha yang bergerak dibidang pemasaran online yang berada di bawah naungan PT. Dialogue Garmindo Utama dan tergabung sebagai perusahaan distributor dalam Dialogue Management Group. CV. Karya Anak Bangsa didirikan pada tanggal 01 Oktober 2021 yang berada di Dusun Tinggarjaya RT. 002/002 Desa Tinggarjaya Kec. Sidareja, Kab. Cilacap.</p>", unsafe_allow_html=True)

    st.title("Visi")
    st.markdown("<p style='font-size: 16px; text-align: justify;'>Visi dari Dialogue Group adalah Menjadi partner terpercaya yang mendampingi perjalanan & peran seorang Ibu.</p>", unsafe_allow_html=True)

    st.title("Misi")
    st.markdown("<p style='font-size: 16px; text-align: justify;'>Misi dari Dialogue Group adalah Membangun Generasi & Bangsa untuk Kehidupan yang Lebih Baik</p>", unsafe_allow_html=True)
